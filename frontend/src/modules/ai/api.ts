...
export async function validateTaskSMART(
  ...
  const response = await api.post<ApiResponse<SMARTValidationResponse>>(
    "/ai/validate-smart",
    data
  );
...
export async function applySMARTSuggestions(
  ...
  const response = await api.post<ApiResponse<{ success: boolean; message: string; recommendations_applied: string[] }>>(
...
export async function getConversationWithMessages(
  ...
  const response = await api.get<ApiResponse<AIConversationWithMessages>>(
...
export async function startDialog(
  ...
  const response = await api.post<ApiResponse<StartDialogResponse>>(
